...
z = -x + y if y > 0 else -x - y

# соглашения о стиле кода
# PEP8 (Python Enhancement Proposal 8) - описан "правильный"
# стиль программирования в пайтон
...
#   Замечание: когда вы используете аббревиатуры в таком стиле, 
#   пишите все буквы аббревиатуры заглавными —
...
# (слова с заглавными буквами и подчеркиваниями — уродливо!)

# автоматическое переименование в PyCharm и подсказки - вам не нужно набирать 
# длинные названия переменных

pets = ['cat', 'wolf', 'ostrich']
if 'lion' in pets:
  print('Wow!')

# В каждой уважающей себя компании есть style guide (стайл-гайд) -  
# стилю руководство понаписания кода.
# Практически все они основываются на PEP8, с небольшими исключениями,  
# принятыми в этой команде.
